...
type SharedInformerFactory interface {
	...
	Topocontroller() topocontroller.Interface
}

func (f *sharedInformerFactory) Topocontroller() topocontroller.Interface {
	return topocontroller.New(f, f.namespace, f.tweakListOptions)
}
