	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TopocontrollerV1alpha1().NodeResourceTopologies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TopocontrollerV1alpha1().NodeResourceTopologies(namespace).Watch(context.TODO(), options)
			},
		},
		&topocontrollerv1alpha1.NodeResourceTopology{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeResourceTopologyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&topocontrollerv1alpha1.NodeResourceTopology{}, f.defaultInformer)
}
